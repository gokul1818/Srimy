        ...
        <div className="card card-1">
          <div className="card-header bg-white">
            <div className="media flex-sm-row flex-column-reverse justify-content-between  ">
              ...
              {/* <div className="col-auto text-center  my-auto pl-0 pt-sm-4"> <img className="img-fluid my-auto align-items-center mb-0 pt-3"  src="https://i.imgur.com/7q7gIzR.png" width="115" height="115"> <p className="mb-4 pt-0 Glasses">Glasses For Everyone</p>  </div> */}
            </div>
          </div>
                    ...
                    <div className="row ">
                      ...
                      <div className="col mt-auto">
                        ...
                        <div className="media row justify-content-between ">
                          ...
                          {/* <div className="col-auto flex-col-auto"><smallclassName="text-right mr-sm-2">Delivered</small><span> <i className="fa fa-circle"></i></span></div> */}
                        </div>
                      </div>
                    </div>
                  </div>
